...
(async () => {
  ...
  await fs.writeFile("secondary-malignancy_pleura-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("secondary-malignancy_pleura-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
